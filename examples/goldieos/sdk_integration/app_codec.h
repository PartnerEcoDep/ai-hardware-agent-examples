...
typedef enum {
    APP_CODEC_G711A     = 0,  /**< G.711 A-law, 8kHz, 2:1 (default) */
    APP_CODEC_PCM16     = 1,  /**< PCM 16-bit, 8kHz, no compression */
    APP_CODEC_OPUS      = 2,  /**< Opus, 16kHz (requires CONFIG_APP_ENABLE_OPUS) */
    APP_CODEC_G711U     = 3,  /**< G.711 mu-law, 8kHz, 2:1 */
    APP_CODEC_IMA_ADPCM = 4,  /**< IMA-ADPCM, 8kHz, 4:1 */
    APP_CODEC_MAX
} app_codec_id_e;
...
/**
 * Encode PCM16 mono samples to encoded frame.
 *
 * @param pcm       Input PCM16 samples (mono, int16_t)
...
/**
 * Decode encoded frame to PCM16 mono samples.
 *
 * @param buf        Input encoded data
 * @param len        Input data length in bytes
 * @param pcm        Output PCM16 buffer
