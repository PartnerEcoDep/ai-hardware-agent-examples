...
The component wrapper provides the source package with
`CONVAI_PROJECT_VERSION`. The shared `../../cmake/ConvaiVersion.cmake` combines
the numeric release with the Git commit count and short hash. Both the
