/**
 * @file main.c
 * @brief ESP32-S3 AI Hardware Agent entry point (laiwfs300 板).
 *
 * Boot sequence (delegated to focused modules):
 *   1. GPIO / status LED
 *   2. NVS
 *   3. I2C bus + TPT29555A IO expander
...
void app_main(void) {
  ...
  /* 3-4. I2C bus + TPT29555A */
  if (board_init_all() != ESP_OK) {
    printf("[3-4/8] I2C/TPT29555A FAILED, skipping hardware\n");
    goto skip_hw;
  }
  printf("[3-4/8] I2C/TPT29555A OK\n");
  fflush(stdout);
